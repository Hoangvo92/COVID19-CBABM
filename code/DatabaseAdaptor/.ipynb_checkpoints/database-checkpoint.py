...
init_infected = 0.001 # % of initial infected population
init_vaccinated = 0.575 # % of initial vaccinated population
exposure_distance = 100 
n_days = 30
weather = 1 
policy=2
...
geojson_name = "nyu-2451-34561-geojson.json" #"nyu-2451-34561-geojson.json"#"city_of_houston.json"#"houston.geojson"#"TorontoNeighbourhoods.geojson" # change  to houston city geojson file later
MAP_COORDS =  [40.730610, -73.935242] # [40.730610, -73.935242]#[43.741667, -79.373333]  # Toronto   #change to houston city later [29.749907, -95.358421]
unique_id = "id" #"OBJECTID"#"HOODNUM"  # "BG_ID"

###### Distribution of Citizens
    ## distribution of Human agents based on Profession, including max age and min age
student_df = [4, 30, 0.2] # min_age, max_age, percentage
employed_df = [18, 70, 0.58]
healthcare_df = [25, 70, 0.165]
unemployed_df = [10, 81, 0.055]
    ## distribution of Human agents based on Gender
male = 0.477
female = 0.523
    ## Distribution of Human agents based on age
age = [0.1229, 0.358, 0.2673, 0.2512] # 0-12, 13-34, 35-54, 55
...
infection_risk= 0.0015
#Initial death rate
death_risk = 0.0000015
#Initial exposed rate or exposed rate of the first month
expose_rate = 0.036 
#hospitalized rate- remain constant
hosp_rate = 0.000158 #0.14# hospital rate in 2021
#vaccinated rate
vaccination_rate=0.098 
...
wait_time = 15 ## each step lasts 15 seconds : 300 = 12 * 15
